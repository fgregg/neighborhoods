...
neighborhoods, by using three criterion: 1.) Are the proposed
neighborhood recognizable to people who are supposed to be a part of
it, 2.) Does a particular way of defining neighborhoods help predict
social processes we believe to operate at neighborhood scales, 3.) Are
the neighborhoods consistent with reasonable theories of neighborhood
formation? I believe these criterion should be applicable to wide
class of social groupings besides neighborhoods.
