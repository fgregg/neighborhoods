...
cut.\cite{greig_exact_1989}
 ...
 computer vision community leading leading to theoretical
...
that have the following form.\footnote{We can also use
  these techniques on scoring functions that have a term for the
