...
four block city, our preferred neighborhood assignment got the best
score when the block-by-block similarities were 1, -1, -1, 1. That
...
such that our preferred assignment is has a lower score than any other
...
&\text{for all } \mathbf{y} \text{ where } \mathbf{y} \text{ is in the set of
  possible neighborhood assignments}\\
&\xi { is a slack variable and  } \Delta \text{ is an empirical loss.}\\
\end{align*}
%
