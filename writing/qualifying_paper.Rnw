...
Unfortunately, we should be very suspicious of a private understanding
of where the boundaries of neighborhoods are. In Albert Hunter's study
of Chicago's perceptions of neighborhoods, he asked 801 Chicago
residents to answer two questions: ``What is the name of this part of
Chicago?'' and ``What are the boundaries of this area?''
[69]. Eighty-five percent of respondents were able to provide a name,
but only 65\% were able to provide four boundaries of the
area. Hunter, did not reveal whether the boundaries overlapped, but
the work of other researchers shows that residents rarely agree about
all four boundaries of their own neighborhood.(Campbell Lee). There is
no particularly reason to prefer a researcher's private understanding
