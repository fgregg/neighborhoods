...
City residents often see their city as composed of many, usually
distinct areas they call neighborhoods. These perceived neighborhoods
can form the basis of how residents navigate the city, act
collectively, choose where to live, or decide to invest. While urban
sociologists have long argued for the importance of the perceived
neighborhood, we have little understanding of how people come to see
an area as a neighborhood.

In part, this is because previous research has suggested that people
do not come to see an area as a neighborhood, but that residents have
idiosyncratic perceptions of neighborhoods. If people see very
different areas when they see neighborhoods, then it makes little
sense to ask how a particular area comes to be seen as a
neighborhood--it does not. 

Recent research in neighborhood perception has largely been concerned
with how individual residents' social statuses determine their
neighborhood perception and how residents distinguish between
neighborhoods in order to serve status needs. However, it's not clear
how different residents' perceptions of neighborhoods truly are.

While residents give very different responses when asked to define the
area of their neighborhood, this may have more to do with the
difficulty of the task than different perceptions of the
neighborhood. Defining a the area of a neighborhood is a difficult
cognitive tasks. Respondents typically express uncertainty about one
or more of the borders, and, if allowed, will often omit some borders
altogether.

Even if residents truly do see their neighborhoods as covering
different areas, these areas can substantially overlap. Indeed, if we
could collect enough perceptions of a neighborhood, we may be identify
a particular area which residents are likely to identify as their
neighborhood. Up to now, urban sociologists have not collected the
necessary data to test whether these potential `average neighborhood
perceptions' emerge.

In this paper, I discuss a novel Internet source for proxy data on
neighborhood perception. In addition, I present an approach for
investigating what elements of the urban landscape residents may
responding to when they see this place as different than that place. 
...
Indeed, there
may be well defined areas that residents tend to see as belonging the
their neighborhood. However, in order to capture 
In order to 


There may be a
well-defined area If we
aggregated enough perceptions, the idiosyncrasies may wash out, leaving
a well defined area of average neighborhood perception. 


Whether This is an empirical question that 





Resident's to these tasks vary a great deal, but 



en pressed, residents will draw very different
maps and nominate different boundaries. 


Residents will also express
uncertainty about their ability to answer  
