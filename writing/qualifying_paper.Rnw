...
In Figure \ref{fig:prob}, we visualize the estimated probabilities for
neighborhood claims on a map of the North Side of Chicago. Each color
...
from one neighborhood to another. For context, the map shows the
lakefront park, the north branch of the Chicago river, railroad
embankments (brown-dashed lines), and, in gray, the borders of
Community Areas--areas defined by Ernest Burgess in the 1920s, which
he believed had and would continue to have distinct social histories.
