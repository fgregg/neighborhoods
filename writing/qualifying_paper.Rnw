...
Residents are able to coordinate their actions through personal
contacts with neighbors, formal organizations, or shared perceptions
and beliefs about the neighborhood. These different bases for action
imply different sets of relevant neighbors. For keeping an eye out for
...
While we have some understanding
of how residents develop personal relations with their neighbors and
how formal organizations can solve local coordination problems, we
know little about how residents come to share perceptions and beliefs
about neighborhoods.
...
In the neighborhood effects
literature, the problem is typically informal social control,
particularly of youth. 

either coordinated,
joint action with their neighbors or upon resident's private beliefs
about what their neighbors will do. Classically, examples include
informal maintenance of social order and investment or disinvestment
in real property.

The neighborhood effects literature has demonstrated that residents in
different parts of cities differ in their beliefs about their
neighbors likelihood to act to maintain social order. Areas where
residents report that their neighbors are likely to act are more
likely to have X,Y,Z and less likely to have A,B,C. These
'neighborhood effects' persist after controlling for poverty, x, z.



We have much to learn about what produces these differences in beliefs
about neighbors and about the relation between those beliefs and
social order within an area. We can start by who counts as neighbors
and for which types of collective action problems. If a neighborhood
faces collective action problems, is capacity to respond depends on
...
should
start by understanding which sets of people are party to the different
collective action problems faced by residents.
