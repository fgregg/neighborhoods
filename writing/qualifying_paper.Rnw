...
partition of the network called a minimum cut. Finally, a method of
...
\section*{Discussion}
We now have means for identifying average perceived neighborhoods and
validating that they line up with expected physical barriers and
spatial differences in sociological characteristics. This lays the ground
for how beliefs and perceptions of these neighborhoods affect social
processes in urban life. 

The preliminary work on modeling the neighborhoods can be extended,
and structure supported vector machine give us the tools to further
study how parts of a city come to be seen as distinct areas.

In addition, the general approach we have taken for neighborhoods can
be used in other fields of social life.In the social sciences, we have
a long tradition of learning about society by asking people
questions. However, we usually don't do this to try to identify what
social groupings are meaningful. In part this is because people often have
a difficult time coming up with credible ways of identifying the
boundaries of a group, social movement, or class.

People can often reveal patterns of affiliation, either directly
when we ask what kind of person they are, or indirectly when we ask
about their friends and things they like and don't like. We haven't
had good, quantitative tools for aggregating these patterns of affiliation 
or revealing their logic. 

The case of the neighborhood is easier than many social
groupings. But, if the approaches we have discussed here help us
locate what parts of the social world people think are real, and gives
us techniques for thinking about why, then we can extend this work to
reveal the core groupings of our society and our science.
